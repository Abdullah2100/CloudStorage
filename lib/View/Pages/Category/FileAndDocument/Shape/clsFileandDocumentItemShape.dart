...
class clsFileandDocumentItemShape extends StatefulWidget {
  clsLinkAndSiteModle  modle;
  int categoryId;
  BuildContext context;
  Function onComplate;

  clsFileandDocumentItemShape(
      {super.key,
      required this.modle,
  ...
  @override
  State<clsFileandDocumentItemShape> createState() => _clsFileandDocumentItemShapeState();
}

class _clsFileandDocumentItemShapeState extends State<clsFileandDocumentItemShape> {
  @override
