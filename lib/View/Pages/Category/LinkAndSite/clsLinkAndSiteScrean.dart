...
import 'clsAddOrUpdateLinkAndSiteScrean.dart';

class clsLinkAndSiteScrean extends StatefulWidget {
  clsCategoryModle modle;

  clsLinkAndSiteScrean({super.key, required this.modle});

  @override
  State<clsLinkAndSiteScrean> createState() => _clsLinkAndSiteScreanState();
}

class _clsLinkAndSiteScreanState extends State<clsLinkAndSiteScrean> {
